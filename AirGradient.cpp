...
//     _SoftSerial_PMS = new HardwareSerial(rx_pin, tx_pin);
//     PMS(*_SoftSerial_PMS);
...
void AirGradient::CO2_Init(int rx_pin, int tx_pin, int baudRate) {
    ...
    // Serial1 = new HardwareSerial(rx_pin, tx_pin);
...
//     }
//     _SoftSerial_MHZ19 = new HardwareSerial(rx_pin, tx_pin);
